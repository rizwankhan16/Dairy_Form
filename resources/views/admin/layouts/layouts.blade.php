...
<body>
		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Panel</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
					...
					<li class="sidebar-item {{ request()->Routeis('Attribute .create') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{route('Attribute .create')}}">
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
            </a>
					</li>

					<li class="sidebar-item {{ request()->Routeis('Attribute .manage') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{route('Attribute .manage')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
            </a>
					</li>
					<li class="sidebar-header">
    ...
    <a class="sidebar-link" href="{{ route('admin.cart.history') }}">
        <i class="align-middle" data-feather="plus"></i> <span class="align-middle">cart_history</span>
    </a>
</li>
