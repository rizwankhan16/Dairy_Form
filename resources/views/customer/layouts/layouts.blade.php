		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">customer Panel</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">history</span>
					...
					<li class="sidebar-item {{ request()->Routeis('customer. affliate') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{route('customer.affliate')}}">
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">affliate</span>
            </a>
					</li>
